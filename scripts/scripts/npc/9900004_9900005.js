    ...
    if (mode == -1) {
        ...
        if (status == 0) {
            ...
            if (selection == 3) {
                ...
                var map = Packages.net.channel.ChannelServer.getInstance(1).getMapFactory().getMap(220080001);
                var nao1 = map.getCharacters().toArray().length;
                var map = Packages.net.channel.ChannelServer.getInstance(2).getMapFactory().getMap(220080001);
                var nao2 = map.getCharacters().toArray().length;
                var map = Packages.net.channel.ChannelServer.getInstance(3).getMapFactory().getMap(220080001);
                var nao3 = map.getCharacters().toArray().length;
                var map = Packages.net.channel.ChannelServer.getInstance(4).getMapFactory().getMap(220080001);
